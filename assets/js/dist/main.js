...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (blueskyFeedContainer) {
    ...
    root.render(/*#__PURE__*/React.createElement(BlueskyUpdates));
  }
  ...
  if (nextCommitteeMeetingContainer) {
    ...
    root.render(/*#__PURE__*/React.createElement(NextCommitteeMeeting, {
  ...
  if (upcomingEventsContainer) {
    ...
    root.render(/*#__PURE__*/React.createElement(UpcomingEvents, {
      calendarUrl: calendarUrl
    }));
  }
});
