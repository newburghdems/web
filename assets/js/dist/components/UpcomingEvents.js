...
const UpcomingEvents = ({
  ...
  if (loading) {
    return /*#__PURE__*/React.createElement("div", {
      className: "container mx-auto px-4 sm:px-6 lg:px-8 text-center py-10"
    }, /*#__PURE__*/React.createElement(Loader2, {
      className: "h-12 w-12 animate-spin text-dem-blue-500 mx-auto"
  ...
  if (error) {
    ...
    }, translations.could_not_load_events, ": ", error));
  }
  if (otherEvents.length === 0) {
    ...
    }, translations.no_upcoming_events), /*#__PURE__*/React.createElement("div", {
      className: "text-center mt-12 sm:mt-16"
    }, /*#__PURE__*/React.createElement("a", {
      href: "{eventsPagePath()}",
      className: "inline-flex items-center bg-dem-blue-500 hover:bg-dem-blue-600 text-white font-semibold py-3 px-7 rounded-md text-lg transition-colors duration-300 shadow hover:shadow-md group"
    }, /*#__PURE__*/React.createElement(CalendarPlus, {
      className: "h-5 w-5 mr-2 transform transition-transform duration-200 group-hover:scale-110"
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    ...
    className: "font-inter text-base font-semibold text-dem-blue-500 mb-1"
  }, event.title), /*#__PURE__*/React.createElement("p", {
    className: "text-xs text-gray-600 flex items-center"
  }, /*#__PURE__*/React.createElement(CalendarClock, {
    className: "h-3.5 w-3.5 mr-1.5 text-gray-400 flex-shrink-0"
  }), formatDateTimeForOtherEvents(event.start, event.isAllDay)), event.location && /*#__PURE__*/React.createElement("p", {
    className: "text-xs text-gray-500 mt-1 ml-5"
  }, event.location)))) : /*#__PURE__*/React.createElement("p", {
    className: "font-inter text-gray-600"
  }, translations.also_coming_up)), /*#__PURE__*/React.createElement("div", {
    className: "mt-6"
  }, /*#__PURE__*/React.createElement("a", {
    href: eventsPagePath(),
    className: "inline-flex items-center bg-dem-blue-500 hover:bg-dem-blue-600 text-white font-semibold py-3 px-7 rounded-md text-lg transition-colors duration-300 shadow hover:shadow-md group"
